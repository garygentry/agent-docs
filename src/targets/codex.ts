...
/**
 * PLACEHOLDER for the codex target (04 §7).
 *
 * Item 008 defines the {@link TargetTransform} contract and the registry; the real
 * codex mapping rules are implemented by a later backlog item (009-012), which
 ...
 */
const NOT_IMPLEMENTED = "codex transform not implemented yet (backlog item 009-012)";
