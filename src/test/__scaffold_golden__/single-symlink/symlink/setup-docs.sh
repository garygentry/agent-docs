...
# The script lives at docs/setup-docs.sh, so repo root is computed
# relative to the script's own location (works regardless of caller CWD).
SCRIPT_DIR=$(cd "$(dirname "$0")" && pwd)
REPO_ROOT=$(cd "$SCRIPT_DIR/.." && pwd)
DOCS_PKG_DIR="$REPO_ROOT/docs"
...
link_file "../docs/getting-started.md" "getting-started"
link_file "../docs/guides/usage.md" "guides/usage"
